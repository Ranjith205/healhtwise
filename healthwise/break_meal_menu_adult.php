        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <center><h4>Foodwise Indian</h4></center>
                    ...
                    <form name="break_meal" action="break_meal.php" class="form-basic" method="GET" onSubmit="">
                    <div class="table-responsive"> 
                        <table class="table table-striped" cellpadding="0" cellspacing="0" align="center" width="50%">
                            <tr>
