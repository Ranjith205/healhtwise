...
<section id="contact">
    <div class="container" style="background-color: #ffffff;">
        ...
        */
                ...
                <form name="break_meal" action="break_meal_menu_adult.php" class="form-basic" method="GET" onSubmit="" style="box-shadow:none; height:5px;">
                    <center>
                      <input name="submit2" type="submit" style="width: 250px;"
                                   value="BREAK DAY-PLAN INTO MEALS">
                    </center>
                </form>
                <form action="nutrition.php" method="GET" class="form-basic" onSubmit=""style="box-shadow:none;">
